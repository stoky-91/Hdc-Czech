 ...
 * @author mstok
 */
public class TrainingUser extends javax.swing.JFrame implements Serializable {
     ...
     */
    public TrainingUser() throws SQLException, ParseException {
...
SimpleDateFormat sdf=new SimpleDateFormat("hh:mm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrainingUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TrainingUser().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(TrainingUser.class.getName()).log(Level.SEVERE, null, ex);
